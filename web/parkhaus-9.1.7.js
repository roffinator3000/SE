                        ...
                        if ( more > 0 ){
                            ...
                            for ( let i = this._max; i > this._max + more; i-- ){
                                ...
                                if ( space ){
                                    ...
                                    if ( space.parentElement ) garage_div.removeChild( space );
                                }
                            }
                        }
                        this.rerender();
